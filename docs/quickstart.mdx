---
title: "Quickstart"
description: "Scaffold a browser and API test harness into your project in 2 minutes with iQuest"
---
...
**Moving feature files elsewhere** — update the path in `.iquest/playwright.config.ts` (or `cucumber.js`):
...
- [`examples/playwright-api/`](https://github.com/openqa-labs/openqa/tree/main/examples/playwright-api) — Hybrid UI + API tests